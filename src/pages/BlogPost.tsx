      ...
      const processNode = (node: any): string => {
                ...
                const linkText = textNode.content
                  .map((linkContentNode: any) => {
                    if (linkContentNode.nodeType === "text") {
                      ...
                      if (
                        linkContentNode.marks &&
                        Array.isArray(linkContentNode.marks)
                      ) {
        ...
        if (node.nodeType === "heading-1" && node.content) {
          const headingText = node.content
            ...
            .join("");
          return headingText
            ? `<h1 class="text-3xl font-bold mb-4">${headingText}</h1>`
            : "";
        }
        ...
        if (node.nodeType === "heading-2" && node.content) {
          const headingText = node.content
            ...
            .join("");
          return headingText
            ? `<h2 class="text-2xl font-bold mb-3">${headingText}</h2>`
            : "";
        }
        ...
        if (node.nodeType === "unordered-list" && node.content) {
          const listItems = node.content
            ...
            .join("");
          return listItems
            ? `<ul class="list-disc pl-6 mb-4">${listItems}</ul>`
            : "";
        }
