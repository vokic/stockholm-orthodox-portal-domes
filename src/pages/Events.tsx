                    ...
                    <div key={index} className="py-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="flex justify-center md:justify-end items-center">
                          <button className="btn-primary text-sm">Add to Calendar</button>
                        </div>
                      </div>
                    </div>
                  ))}
            ...
            <div className="card">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <p>Weekly classes for children to learn about the Orthodox faith and traditions.</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p>Regular scripture study and discussion groups for adults of all ages.</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p>Preparing meals and collecting donations for local homeless shelters.</p>
                </div>
              </div>
              
              <div className="mt-8 text-center">
                <p className="mb-4">Want to get involved? We welcome volunteers for all our community activities!</p>
